        ...
        <div className="grid md:grid-cols-2 gap-12 items-center mb-16">
          <div>
            ...
            <div className="space-y-4 text-white montserrat-regular">
              <p>
                Soy desarrollador frontend con más de 2 años de experiencia creando aplicaciones web modernas,
          ...
          <div className="space-y-6">
            <div className="bg-stone-700 p-6 rounded-xl">
              ...
              <p className="text-white montserrat-regular">+2 años desarrollando aplicaciones web</p>
            </div>
            <div className="bg-stone-700 p-6 rounded-xl">
